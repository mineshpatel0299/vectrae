      ...
      <section className="relative overflow-hidden bg-black">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-6 sm:pb-28">
          ...
          <div className="mt-8 grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <span
                className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-[#29B9F2]"
                data-aos="zoom-in"
              >
            ...
            <div
              className="relative h-80 overflow-hidden rounded-3xl border border-white/10 shadow-2xl sm:h-100"
              data-aos="fade-left"
              data-aos-delay="150"
            >
          ...
          <div className="mx-auto mt-12 grid max-w-2xl gap-4 text-left sm:grid-cols-2">
            {solution.benefits.map((benefit, i) => (
              <div
                ...
                data-aos-delay={i * 80}
              >
                <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-[#25D9C7]" />
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6">
                    <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/20 bg-white/10 text-white backdrop-blur-md">
