  ...
  return (
    ...
    >
      <motion.div
        ...
        className="pointer-events-none absolute left-1/2 top-0 h-130 w-225 -translate-x-1/2 -translate-y-1/3 rounded-full bg-[#84D96C]/15 blur-[140px]"
      />
      <motion.div
        aria-hidden
        style={{ x: blob2X, y: blob2Y }}
        className="pointer-events-none absolute bottom-0 right-1/4 h-100 w-100 translate-y-1/3 rounded-full bg-[#29B9F2]/10 blur-[120px]"
      />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-6 pb-16">
        ...
        >
          250+ certified experts deliver AV, Networking, Data Center, End Computing, and Power
          solutions to 2,300+ enterprises PAN-India. Come build it with us.
        </motion.p>
